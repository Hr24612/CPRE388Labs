...
public class AddEventActivity extends Activity {
    ...
    public void addEvent(View view) {
        ...
        //TODO - create an event object using UI variables above
         Event e;
         e = new Event(titleText.getText().toString(), locText.getText().toString(),
                 formatDateTime(startDate.getMonth(), startDate.getDayOfMonth(), startDate.getYear(),
